...
# Configuration
DOCKER_IMAGE="heapsgo0d/ignition-comfyui:v3.1.1-performance"  # Update with your actual Docker Hub username
TEMPLATE_NAME="Ignition ComfyUI v3.1.1-performance"
